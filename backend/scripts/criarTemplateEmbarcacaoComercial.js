 ...
 * 
 * NOTA: Este script está comentado porque o template EMBARCACAO_COMERCIAL
 * já é criado pelo script criarTemplatesChecklist.js que cria templates
 * para JET_SKI, LANCHA e EMBARCACAO_COMERCIAL de uma vez.
 * 
 * Use: node backend/scripts/criarTemplatesChecklist.js
 */
...
console.log('Este script está desabilitado. Use: node backend/scripts/criarTemplatesChecklist.js');
